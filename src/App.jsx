...
import diogenesProfessionalNew from './assets/diogenes-professional-new.jpeg'
import webinarPoster from './assets/webinar-poster.jfif'
...
function App() {
  ...
  const events = [
    {
      title: 'Cibersegurança e Excelência - Webinar',
      organization: 'DTIM Madeira',
      date: '2024',
      description: 'Palestrante convidado em webinar sobre cibersegurança, abordando tópicos de segurança digital e excelência técnica.',
      link: 'https://www.linkedin.com/posts/dtim-madeira_dtimabrmadeira-ciberseguranaexa-webinar-activity-7381645251754520576-t3qt?utm_source=share&utm_medium=member_desktop&rcm=ACoAAC9HoUMBliFYZe5GG6Lk0QBmmkvf5hotkvA',
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center mb-12">
              <div className="space-y-6">
                <p className="text-xl text-muted-foreground leading-relaxed font-semibold">
                  <span className="text-primary">Especialista em Cibersegurança em Transição de Carreira</span> | Bacharelado em Sistemas e TI
                </p>
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Com uma base sólida em gestão administrativa, redes e sistemas, estou a aplicar o meu conhecimento em segurança digital e inteligência artificial para construir laboratórios e projetos de ponta em Cibersegurança.
                </p>
                <p className="text-lg text-muted-foreground leading-relaxed">
                  As minhas certificações internacionais (Oracle Cloud, AWS e Microsoft Azure) demonstram a minha preparação para ambientes multicloud e o meu compromisso com a excelência técnica. Procuro uma oportunidade para alavancar a minha experiência e paixão pela segurança da informação na sua equipa.
                </p>
              </div>
          ...
          <div className="max-w-4xl mx-auto">
            {events.map((event, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <Card className="cyber-border bg-card/80 hover:cyber-glow transition-all duration-300 mb-6">
                  <div className="grid md:grid-cols-3 gap-6 p-6">
                    ...
                    >
                      <div className="relative">
                        <div className="absolute inset-0 cyber-glow rounded-lg"></div>
                        <img
                          src={event.poster || diogenesProfessionalNew}
                          alt={event.poster ? 'Poster da Webinar' : 'Diógenes Aquino Freitas - Palestrante'}
                          className="w-full h-64 rounded-lg object-cover border-4 border-primary/50"
                        />
                      </div>
                    </motion.div>
                  </div>
